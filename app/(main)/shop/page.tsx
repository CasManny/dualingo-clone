      ...
      <div className="flex flex-row-reverse gap-[48px] px-6">
          ...
          <FeedWrapper>
              <div className="w-full flex flex-col items-center">
                  ...
                  <h1 className="tex-center font-bold text-neutral-800 text-2xl my-6">Shop</h1>
                  <p className="text-muted-foreground text-center text-lg mb-6">spend your points on cool stuff</p>
                  <ShopItems hearts={userProgress.hearts} points={userProgress.points} hasActiveSubcription={isPro} />
              </div>
          </FeedWrapper>
    </div>
  )
